...
namespace Infrastructure.Repositories
{
    public class EmailNotification : IEmailNotification
    {
        ...
        public EmailNotification(IBookingRepository bookingRepository)
        {
        ...
        {
            // Fetch the booking details asynchronously
            var bookings = await _bookingRepository.GetBookingDetailAsync(user.Id);
